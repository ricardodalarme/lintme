...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:lintme/src/reporters/resources/variables.css',
      'package:lintme/src/reporters/resources/normalize.css',
      'package:lintme/src/reporters/resources/base.css',
      'package:lintme/src/reporters/resources/main.css',
    ];
