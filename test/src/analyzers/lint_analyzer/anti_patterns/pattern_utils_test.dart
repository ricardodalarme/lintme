import 'package:lintme/src/analyzers/lint_analyzer/anti_patterns/models/pattern.dart';
import 'package:lintme/src/analyzers/lint_analyzer/anti_patterns/pattern_utils.dart';
  ...
  group('Pattern utils', () {
    test(
      ...
      () {
        ...
        final documentationUrl = Uri.parse(
          'https://lintme.dev/docs/individuals/anti-patterns/pattern-id',
        );
    ...
    test('documentation returns the url with documentation', () {
      ...
      expect(
        ...
        equals(
          'https://lintme.dev/docs/individuals/anti-patterns/$patternId1',
        ),
      );
      expect(
