...
import 'package:lintme/src/analyzers/lint_analyzer/rules/models/rule.dart';
import 'package:lintme/src/analyzers/lint_analyzer/rules/models/rule_type.dart';
import 'package:lintme/src/analyzers/lint_analyzer/rules/rule_utils.dart';
  ...
  group('Rule utils', () {
    test(
      ...
      () {
        ...
        final documentationUrl = Uri.parse(
          'https://lintme.dev/docs/individuals/rules/flutter/rule-id',
        );
    ...
    test('documentation returns the url with documentation', () {
      ...
      expect(
        ...
        equals(
          'https://lintme.dev/docs/individuals/rules/flutter/$ruleId1',
        ),
      );
